...
000800*
000810* This is the linkage commarea version of the interface to the
000820* Error Handler program.
000830*
000900     05  CA-ERRH-ERROR-COMMAREA.
001000*
001100* This is an "Eyecatcher" and integrity check field.
001200*
001300         10  CA-ERRH-VERSION             PIC XXX.
001400             88  CA-ERRH-CORRECT-VERSION VALUE 'V1A'.
...
002100*
002200         10  CA-ERRH-ERROR               PIC 9(4).
002300         10  CA-ERRH-ERROR-X REDEFINES CA-ERRH-ERROR
002400                                         PIC X(4).
002500*
...
003000*
003100         10  CA-ERRH-REASON              PIC 9(4).
003200         10  CA-ERRH-REASON-X REDEFINES CA-ERRH-REASON
003300                                         PIC X(4).
003400*
...
003800*
003900         10  CA-ERRH-CICS-FUNCTION       PIC 9(5).
004000         10  CA-ERRH-CICS-FUNCTION-X
004010                 REDEFINES CA-ERRH-CICS-FUNCTION
004100                                         PIC X(5).
004200*
...
004600*
004700         10  CA-ERRH-PROGRAM             PIC X(8).
004800*
...
005300*
005400         10  CA-ERRH-NUMBER              PIC 9(4).
005500*
005600* The array of messages generated.
005700*
005800         10  CA-ERRH-MESSAGES.
005900             15  CA-ERRH-MESSAGE         PIC X(120) OCCURS 3.
